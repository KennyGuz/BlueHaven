...
export default function Header() {
  ...
  const navItems = [
    ...
    { name: "Barcos", link: "/barco-table/", roles:null },
    { name: "Reservas", link: "/reservas", roles: null },  
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <AppBar
      position="static" sx={{ backgroundColor: "#1976D2" }}
        color="primaryLight"
      ...
      >
        <Toolbar>
          ...
          <Tooltip title="Gestión Cruceros">
            <IconButton
              size="large"
              edge="end"
              component="a"
              href="/"
              aria-label="Gestión de Cruceros"
              color="primary"
            >
              <LiveTvIcon />
            </IconButton>
